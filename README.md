...
- Tutor code context: enabled. The frontend sends line-numbered editor code to the backend; tutors may point to short line ranges. Complete solution requests still trigger deterministic refusal, while permitted high-support scaffold modes may provide at most one local repair fragment of up to three logical lines.
