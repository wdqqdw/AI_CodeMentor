...
- When code-level repair is permitted, provide at most one localized fragment of 1-2 logical lines, never in a code block, and never enough to solve the full task by itself; put it in plain text after the relevant line number.
